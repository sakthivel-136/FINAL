...
def get_suggestions(input_text):
    return [q for q in questions_list if input_text.lower() in q][:5]

with st.form("chat_form", clear_on_submit=True):
    col1, col2 = st.columns([10, 1])
    user_input = col1.text_input("Type your question here...", value="", key="input")
...
if submitted and user_input.strip():
    ...
    with st.spinner("KCET Assistant is typing..."):
        time.sleep(1.2)  # Typing simulation
